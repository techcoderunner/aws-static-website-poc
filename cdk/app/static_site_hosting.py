...
class StaticSiteHosting(core.Construct):
    ...
    def __init__(self, scope: core.Construct, myid: str, bucket_name: str) -> None:
        ...
        self.bucket = aws_s3.Bucket(
            self, id="static_website_poc_id", bucket_name=bucket_name, website_index_document='index.html',
